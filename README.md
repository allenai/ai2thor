...
## News
* (9/2019) Version 2.1.0 update of the framework has been added. TableTop typed objects have been expanded to multiple types: DiningTable, TVStand, and CoffeeTable. NightStands have been retyped as SideTables. New Initialization actions have been added. Segmentation image generation has been improved in all scenes. 
