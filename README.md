...
## News
* (9/2019) Version 2.1.0 update of the framework has been added. There have been updates TableTop typed objects to be expanded to DiningTable, TVStand, and CoffeeTable for more type variety. NightStands have been retyped as SideTables. New Initialization actions have been added. Segmentation image generation has been improved. 
