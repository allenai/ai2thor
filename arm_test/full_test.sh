...
export COMMIT_ID="43f62a0aa2a1aaafb6fd05d28bea74fdc866eea1"; export TEST_DETERMINISM_NAME="43f62_determinism.json"
...
python3 test_agent_transport_and_teleport.py --commit_id $COMMIT_ID
python3 test_agent_movement_and_rotation.py --commit_id $COMMIT_ID
python3 test_determinism_transport_and_teleport.py --commit_id $COMMIT_ID
