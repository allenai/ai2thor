...
public class Build
{
    ...
    static void WebGL()
    {
        ...
        build(
            ...
            BuildTarget.WebGL,
            new string[] { "USIM_USE_BUILTIN_JPG_ENCODER", "USIM_USE_BUILTIN_PNG_ENCODER" }
        );
    }
    ...
    private static List<string> GetAllScenePaths()
    {
        ...
        if (IncludePrivateScenes())
        {
            ...
            files.AddRange(
                Directory.GetFiles("Assets/Resources/ai2thor-objaverse/NoveltyTHOR_Assets/Scenes")
            );
        }
        ...
        files.AddRange(
            Directory.GetFiles(
                "Assets/StandardAssets/Characters/FirstPersonCharacter/StretchCalibration/Scenes"
            )
        );
    ...
    private static List<string> GetScenesFromEnv()
    {
        ...
        {
            return Environment
                .GetEnvironmentVariable("BUILD_SCENES")
                .Split(',')
                .Select(x => "Assets/Scenes/" + x + ".unity")
                .ToList();
        }
        else
        {
