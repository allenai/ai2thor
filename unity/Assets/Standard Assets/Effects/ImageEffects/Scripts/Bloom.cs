...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class Bloom : PostEffectsBase
    {
        ...
        public override bool CheckResources()
        {
            ...
            blurAndFlaresMaterial = CheckShaderAndCreateMaterial(
                blurAndFlaresShader,
                blurAndFlaresMaterial
            );
        ...
        public void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            BrightFilter(
                bloomThreshold * bloomThresholdColor,
                quarterRezColor,
            ...
            for (int iter = 0; iter < bloomBlurIterations; iter++)
            {
                ...
                blurAndFlaresMaterial.SetVector(
                    "_Offsets",
            ...
            if (lensflareIntensity > Mathf.Epsilon)
            {
                ...
                else
                {
                    ...
                    float stretchWidth =
                        (hollyStretchWidth * 1.0f / widthOverHeight) * oneOverBaseSize;
                    ...
                    for (int iter = 0; iter < hollywoodFlareBlurIterations; iter++)
                    {
                        ...
                        blurAndFlaresMaterial.SetVector(
                            "_Offsets",
                            new Vector4(
                                stretchWidth * flareXRot,
                                stretchWidth * flareyRot,
                                0.0f,
                                0.0f
                            )
                        );
