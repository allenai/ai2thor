...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class ColorCorrectionCurves : PostEffectsBase
    {
        ...
        public override bool CheckResources()
        {
            ...
            ccMaterial = CheckShaderAndCreateMaterial(
                simpleColorCorrectionCurvesShader,
                ccMaterial
            );
            ccDepthMaterial = CheckShaderAndCreateMaterial(
                colorCorrectionCurvesShader,
                ccDepthMaterial
            );
            selectiveCcMaterial = CheckShaderAndCreateMaterial(
                colorCorrectionSelectiveShader,
                selectiveCcMaterial
            );
        ...
        public void UpdateParameters()
        {
            ...
            if (redChannel != null && greenChannel != null && blueChannel != null)
            {
                for (float i = 0.0f; i <= 1.0f; i += 1.0f / 255.0f)
                {
                    ...
                    rgbChannelTex.SetPixel(
                        (int)Mathf.Floor(i * 255.0f),
                        0,
