...
public class FK_IK_Solver : MonoBehaviour {
    ...
    public Transform armRoot,
        ...
        armWrist,
        armHand;
    public float bone1Length,
        bone2Length,
        bone3Length;
    public Transform FKRootTarget,
        FKShoulderTarget,
        FKElbowTarget,
        FKWristTarget;
    ...
    public void ManipulateArm() {
        ...
        if (isIKDriven == true) {
            ...
            if (
                ...
                overlapD =
                    Mathf.Pow(bone2Length, 2)
                    - Mathf.Pow(bone3Length, 2)
                    - Mathf.Pow(p1x, 2)
                    - Mathf.Pow(p1y, 2)
                    - Mathf.Pow(p1z, 2)
                    + Mathf.Pow(p2x, 2)
                ...
                overlapParameter = FindParameter(
                    p1x,
                    p1y,
                    p1z,
                    overlapA,
                ...
                overlapCenter = new Vector3(
                    p1x + overlapA * overlapParameter,
                    p1y + overlapB * overlapParameter,
                    p1z + overlapC * overlapParameter
                );
                ...
                overlapRadius = Mathf.Sqrt(
                    Mathf.Pow(bone2Length, 2) - (overlapCenter - armShoulder.position).sqrMagnitude
                );
                ...
                hintProjection = new Vector3(
                    p3x + overlapA * overlapParameter,
                    p3y + overlapB * overlapParameter,
                    p3z + overlapC * overlapParameter
                );
                elbowPosition =
                    overlapCenter + overlapRadius * (hintProjection - overlapCenter).normalized;
    ...
    void AlignToJointNormal(
        Transform armComponent,
        Transform root,
        Transform mid,
        Transform tip,
