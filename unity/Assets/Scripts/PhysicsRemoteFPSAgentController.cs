...
namespace UnityStandardAssets.Characters.FirstPerson {
    ...
    public partial class PhysicsRemoteFPSAgentController : BaseFPSAgentController {
        ...
        protected Collider[] collidersWithinCapsuleCastOfAgent(float maxDistance) {
            ...
            return Physics.OverlapCapsule(point0, point1, maxDistance, LayerMask.GetMask("SimObjVisible", "Procedural1", "Procedural2", "Procedural3", "Procedural4"), QueryTriggerInteraction.Collide);
        }
        ...
        public void PointsOverTableWhereHandCanBe(string objectId, float x, float z) {
            ...
            for (int i = -xSteps; i <= xSteps; i++) {
                for (int j = zStart; j < 11; j++) {
                    ...
                    RaycastHit hit;
                    if (Physics.Raycast(testPosition, -transform.up, out hit, 1f, LayerMask.GetMask("SimObjVisible", "Procedural1", "Procedural2", "Procedural3", "Procedural4"))) {
        ...
        public void OpenWithHand(ServerAction action) {
            ...
            RaycastHit hit;
            int layerMask = LayerMask.GetMask("SimObjVisible", "Procedural1", "Procedural2", "Procedural3", "Procedural4", "SimObjInvisible");
        ...
        public void TouchThenApplyForce(ServerAction action) {
            ...
            if (
                Physics.Raycast(
                    ...
                    out hit,
                    action.handDistance,
                    LayerMask.GetMask("Default", "SimObjVisible", "Procedural1", "Procedural2", "Procedural3", "Procedural4", "Agent"),
                    QueryTriggerInteraction.Ignore
                )
            ) {
