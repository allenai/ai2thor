...
public static class ReceptacleRestrictions {
    ...
    {
        SimObjType.BathtubBasin,
        SimObjType.SinkBasin
    };
    ...
    {
        SimObjType.DiningTable,
        SimObjType.TVStand,
        SimObjType.CoffeeTable,
        SimObjType.SideTable,
        SimObjType.Desk,
        SimObjType.Dresser,
    ...
    public static List<SimObjType> InReceptaclesThatOnlyCheckBottomFourCorners =
        new List<SimObjType>()
        {
            SimObjType.Cup,
            SimObjType.Bowl,
    ...
    public static List<SimObjType> SpawnOnlyOutsideReceptacles = new List<SimObjType>()
    {
        ...
        SimObjType.ToiletPaperHanger,
        SimObjType.Toilet,
        SimObjType.Floor,
        SimObjType.Chair,
        SimObjType.ArmChair,
        SimObjType.Footstool,
    };
    ...
    public static List<SimObjType> AlwaysPlaceUpright = new List<SimObjType>()
    {
        ...
        SimObjType.Mug,
        SimObjType.Laptop,
        SimObjType.SaltShaker,
        SimObjType.PepperShaker,
        SimObjType.AlarmClock,
        SimObjType.Box,
        SimObjType.SoapBottle,
        SimObjType.SoapBottleFilled,
        SimObjType.Kettle,
        SimObjType.Bottle,
        SimObjType.CreditCard,
        SimObjType.RemoteControl,
        SimObjType.Candle,
        SimObjType.SprayBottle,
        SimObjType.Statue,
        SimObjType.Vase,
        SimObjType.KeyChain,
        SimObjType.CD,
    ...
    public static Dictionary<SimObjType, List<SimObjType>> PlacementRestrictions = new Dictionary<
        SimObjType,
        List<SimObjType>
    >()
    {
        ...
        }, // might want to add this to coffee machines later, but right now they don't fit, only mugs were created to fit coffee machines initially
        // DISH SPONGE
        {
        ...
        // HAND TOWEL- small hand towel
        {
            ...
            new List<SimObjType>() { SimObjType.HandTowelHolder, }
        },
        // KETTLE
        {
            SimObjType.Kettle,
        ...
        {
            SimObjType.Plunger,
            new List<SimObjType>() { SimObjType.Cart, SimObjType.Cabinet, SimObjType.Floor }
        },
        // POT
        {
            SimObjType.Pot,
        ...
        {
            SimObjType.Towel,
            new List<SimObjType>() { SimObjType.TowelHolder, }
        },
        // VASE
        {
            SimObjType.Vase,
