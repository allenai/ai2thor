...
Shader "Custom/NonAdditiveEmissiveDeferredDecal" {
    Properties 
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata_base v)
            {
                ...
                // newer
                o.rayToCamera = UnityObjectToViewPos(v.vertex.xyz) *  float3(-1, -1, 1);
            ...
            void frag (v2f i, out half4 outDiffuse : COLOR0, out half4 outSpecular : COLOR1, out half4 outEmission : COLOR2) //: SV_Target
            {
                ...
                //  outEmission = _Emissiveness;

                outEmission = half4(_Emissiveness, _Emissiveness, _Emissiveness, color.a);
                //outEmission = half4(0.72, 0.72, 0.72, color.a);
                outSpecular = half4(174.0/255, 176.0/255, 180.0/255, 1);
                // outSpecular = half4(_Specular, _Specular, _Specular, 1);
