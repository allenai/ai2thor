		...
		public void Execute(string command) {
			...
			switch (splitcommand[0]) {
				...
				case "cr": {
						...
						TextAsset text = Resources.Load<TextAsset>("rooms/" + "1.json");
						//var json = text.text;
						...
						var jsonStr = System.IO.File.ReadAllText(Application.dataPath + "/Resources/rooms/1.json");
